<?php
    ...
    class Branches {
        private static $table_name = "branches";
        protected static $db_fields = array('id', 'verify_string', 'business_string', 'head_designation', 'head_name', 'phone', 'email', 'address', 'town', 'lga', 'state_id', 'state', 'created', 'last_updates');
        public $id;
        public $verify_string;
        public $business_string;
        public $head_designation;
        public $head_name;
        public $phone;
        public $email;
        public $address;
        ...
        private function check_errors(){
            if(empty($this->business_string)){
                $this->errors[] = "The Business must be provided";
            }
            if(empty($this->head_designation)){
                $this->errors[] = "Designation or Title of the Head of Branch must be provided";
            }
            if(empty($this->head_name)){
                $this->errors[] = "Name of the Person in charge of the Branch must be provided";
            }
            if(empty($this->phone)){
                $this->errors[] = "Phone Number must be provided";
            }
            if(empty($this->address)){
                $this->errors[] = "The Address of the Business must be provided";
            }
            if(empty($this->town)){
                $this->errors[] = "The Town of the Branch must be provided";
            }
            if(empty($this->lga)){
                $this->errors[] = "The Local Government Area must be provided";
            }
            if(empty($this->state_id)){
                $this->errors[] = "The State must be provided";
            }
        }
        ...
        public function insert(){
            ...
            if(empty($this->errors)){
                ...
                if($this->save()){
                    ...
                    $this->errors[] = "The Branch was not saved";
                    return false;
                }
            } else {
                return false;
