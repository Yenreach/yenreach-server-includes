<?php
    ...
    class BusinessWorkingHours {
        private static $table_name = "businessworkinghours";
        protected static $db_fields = array('id', 'verify_string', 'business_string', 'day', 'timing', 'opening_time', 'closing_time', 'created', 'last_updated');
        public $id;
        ...
        private function check_errors(){
            ...
            if(empty($this->day)){
                $this->errors[] = "The Day must be provided";
            }
            if(empty($this->opening_time)){
                $this->errors[] = "The Business Opening Time must be Provided";
            }
        }
        ...
        public function insert(){
            ...
            if(empty($this->errors)){
                ...
                if($this->save()){
                    ...
                    $this->errors[] = "The Working Hour was not saved";
                    return false;
                }
            } else {
                return false;
