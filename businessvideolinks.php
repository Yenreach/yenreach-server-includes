<?php
    ...
    class BusinessVideoLinks {
        private static $table_name = "businessvideolinks";
        protected static $db_fields = array('id', 'verify_string', 'user_string', 'business_string', 'video_link', 'real_link', 'platform', 'created', 'last_updated');
        public $id;
        ...
        private function check_errors(){
            if(empty($this->platform)){
                $this->errors[] = "Platform where Video was uploaded must be provided";
            }
            if(empty($this->video_link)){
                $this->errors[] = "The Link of the Uploaded Video must be provided";
            }
        ...
        public function insert(){
            ...
            if(empty($this->errors)){
                ...
                if($this->save()){
                    ...
                    $this->errors[] = "The Video Link was not saved";
                    return false;
                }
            } else {
                return false;
		...
		public static function find_by_user_string($string){
		    return self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE user_string='{$string}' ORDER BY business_string ASC, created ASC");
		}
