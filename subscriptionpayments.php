<?php
    ...
    class SubscriptionPayments {
        private static $table_name = "subscriptionpayments";
        protected static $db_fields = array('id', 'verify_string', 'user_type', 'user_string', 'business_string', 'subscription_string', 'paymentplan_string', 'status', 'created', 'last_updated');
        public $id;
        ...
        private function check_errors(){
            if(empty($this->user_type)){
                $this->errors[] = "User Type was not stipulated";
            }
            if(empty($this->user_string)){
                $this->errors[] = "User String was not provided";
            }
            if(empty($this->business_string)){
                $this->errors[] = "Business was NOT provided";
            }
            if(empty($this->subscription_string)){
                $this->errors[] = "The Subscription String was not provided";
            }
            if(empty($this->paymentplan_string)){
                $this->errors[] = "The Payment Plan was not provided";
            }
        }
        ...
        public function insert(){
            ...
            if(empty($this->errors)){
                ...
                if($this->save()){
                    ...
                    $this->errors[] = "The Subscription Payment was not created";
                    return false;
                }
            } else {
                return false;
