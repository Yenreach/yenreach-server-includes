<?php
    ...
    class ProductCategories {
        private static $table_name = "productcategories";
        protected static $db_fields = array('id', 'category_string', 'category', 'product_string', 'created_at', 'updated_at');
        public $id;
        ...
        private function check_errors(){
            ...
            if(!empty($this->product_string) && !empty($this->category_string)){
                $fsql = "SELECT * FROM ".self::$table_name." WHERE category_string='{$this->category_string}' AND product_string='{$this->product_string}'";
        ...
        public function insert(){
            ...
            if(empty($this->errors)){
                ...
                if($this->save()){
                    ...
                    $this->errors[] = "Category was not added to the product";
                    return false;
                }
            } else {
                return false;
		...
		public static function find_by_product_string($string){
		    return self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE product_string='{$string}' ORDER BY category ASC");
		}
